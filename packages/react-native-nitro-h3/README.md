...
Brings [H3](https://h3geo.org/) to native iOS and Android applications. It vendors the H3 C library (v4.5.0) and calls it directly from native code instead of running it through JavaScript or WebAssembly.
